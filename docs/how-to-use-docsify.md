...
![图片](how-to-use-docsify.assets/640.png)
...
![图片](how-to-use-docsify.assets/640-16540761860683.png)

修改完成之后，你就会发现我们的文档网站多了侧边栏，你点击侧边栏对应的内容在右边显示。

![图片](how-to-use-docsify.assets/640-16540762246716.png)

### 3.3 修改主页内容

修改 REDME.md，内容如下：

![图片](how-to-use-docsify.assets/640-16540762753649.png)

然后我们的文档网站的主页就变成了这样：

![图片](how-to-use-docsify.assets/640-165407639801612.png)
...
![图片](how-to-use-docsify.assets/640-165407659649015.png)

然后，我们再打开网站的时候，就有了封面，如下图所示：

![图片](how-to-use-docsify.assets/640-165407661277918.png)
...
![图片](how-to-use-docsify.assets/640-165407669470621.png)
...
![图片](how-to-use-docsify.assets/640-165407693684224.png)
...
![图片](how-to-use-docsify.assets/640-165407703634227.png)

![图片](how-to-use-docsify.assets/640-165407704904530.png)
...
![图片](how-to-use-docsify.assets/640-165407706713133.png)

注意把下面的是否开源勾选为公开，不然别人无法访问。

![图片](how-to-use-docsify.assets/640-165407708403736.png)

**2.选择 Gitee Pages 服务**

![图片](how-to-use-docsify.assets/640-165407710372739.png)

![图片](how-to-use-docsify.assets/640-165407711937742.png)

**3.收获喜悦的成果**

![图片](how-to-use-docsify.assets/640-165407715240645.png)